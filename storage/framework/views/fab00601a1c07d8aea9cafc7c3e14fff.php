        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td class="value"><?php echo e($data['name']); ?></td>
                </tr>
                <tr>
                    <td class="label">Телефон:</td>
                    <td class="value"><?php echo e($data['phone']); ?></td>
                </tr>
                <tr>
                    <td class="label">Коментар:</td>
                    <td class="value"><?php echo e($data['message'] ?? 'Не вказано'); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<?php /**PATH E:\Herd\himpost\resources\views/mail/callback.blade.php ENDPATH**/ ?>