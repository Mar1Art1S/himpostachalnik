...
@section('og_image', asset('img/categories/007.png'))
    ...
    <x-section>
        ...
        <x-decor.card>
            <x-category-v title=" {{ __('mes.category_v_title_py_dispersants') }}"
                ...
                image="{{ asset('img/mat_5/01.png') }}" link="{{ route('prod_lak_sikativi') }}"
            ...
            <x-category-v title=" {{ __('mes.category_v_title_py_copolymers') }}"
                ...
                image="{{ asset('img/mat_5/05.png') }}" link="{{ route('prod_lak_akril') }}"
