    ...
    <x-section>
        <x-decor.card>
            <x-category-v title=" {{ __('mes.category_v_title_glue_epdm') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/01.png') }}" link="{{ route('prod_klej_krihti') }}" />
            <x-category-v title=" {{ __('mes.category_v_title_glue_d4_wood') }}"
                description="{{ __('mes.category_v_description_glue_d4_wood') }}"
                image="{{ Vite::asset('resources/img/mat_4/02.png') }}" link="{{ route('prod_klej_dereva_d4') }}" />
            <x-category-v title=" {{ __('mes.category_v_title_glue_clinker_thermal_panels') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/03.png') }}" link="{{ route('prod_klej_sendvich') }}"
            ...
            <x-category-v title=" {{ __('mes.category_v_title_glue_foam_textiles') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/04.png') }}" link="{{ route('prod_klej_tekstilyu') }}" />
            <x-category-v title=" {{ __('mes.category_v_title_glue_bulk_materials') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/05.png') }}" link="{{ route('prod_klej_budivelnih') }}" />
            <x-category-v title=" {{ __('mes.category_v_title_glue_parquet') }}"
                description="{{ __('mes.category_v_description_glue_parquet') }}"
                image="{{ Vite::asset('resources/img/mat_4/06.png') }}" link="{{ route('prod_klej_parketu') }}"
            ...
            <x-category-v title=" {{ __('mes.category_v_title_glue_artificial_grass') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/07.png') }}" link="{{ route('prod_klej_travi') }}" />
            <x-category-v title=" {{ __('mes.category_v_title_glue_paper_cardboard') }}"
                ...
                image="{{ Vite::asset('resources/img/mat_4/08.png') }}" link="{{ route('prod_klej_kartonu') }}" />
        </x-decor.card>
    </x-section>
@endsection
